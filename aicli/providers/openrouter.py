"""
providers/openrouter.py — OpenRouter inference provider.
SSE streaming via httpx (preferred) or urllib fallback.
Aggregates 100+ models; many free. Default: meta-llama/llama-3.1-8b-instruct:free
"""
import json
import asyncio
    ...
    def _request(self, messages, model, stream, temperature=0.7):
        ...
        return urllib.request.Request(
            ...
            headers={"Authorization": f"Bearer {self.api_key}",
                     ...
                     "HTTP-Referer": "https://github.com/aicli",
                     "X-Title": "aicli",
